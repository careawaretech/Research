...
CREATE POLICY "Authenticated update for media-library"
...
CREATE POLICY "Authenticated upload for partner-logos"
ON storage.objects FOR INSERT
WITH CHECK (bucket_id = 'partner-logos' AND auth.role() = 'authenticated');

CREATE POLICY "Public read access for grant-logos"
ON storage.objects FOR SELECT
USING (bucket_id = 'grant-logos');

CREATE POLICY "Authenticated upload for grant-logos"
ON storage.objects FOR INSERT
WITH CHECK (bucket_id = 'grant-logos' AND auth.role() = 'authenticated');

CREATE POLICY "Public read access for how-it-works-images"
ON storage.objects FOR SELECT
USING (bucket_id = 'how-it-works-images');

CREATE POLICY "Authenticated upload for how-it-works-images"
ON storage.objects FOR INSERT
WITH CHECK (bucket_id = 'how-it-works-images' AND auth.role() = 'authenticated');

CREATE POLICY "Public read access for team-photos"
ON storage.objects FOR SELECT
USING (bucket_id = 'team-photos');

CREATE POLICY "Authenticated upload for team-photos"
ON storage.objects FOR INSERT
