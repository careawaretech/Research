...
const DiverseTechnologyApplicationsManager = () => {
  ...
  const [section, setSection] = useState<SectionData>({
    title: 'Diverse Technology Applications',
    subtitle: 'WiFi sensing technology deployed across multiple care environments - from hospitals to homes, with consistent privacy protection and HIPAA compliance.',
  ...
  const handleSaveSection = async () => {
    ...
    try {
      const { error } = await supabase
        .from('section_content')
        .upsert({
          section_key: 'diverse-technology-applications',
  ...
  const handleButtonFileUpload = async (buttonType: 'listen' | 'read' | 'watch', file: File) => {
    ...
    try {
      ...
      const filePath = `diverse-technology/${fileName}`;
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold">Diverse Technology Applications</h1>
          </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="p-4 bg-muted/50 rounded-lg border border-primary/20">
              ...
              <p className="text-lg font-mono font-bold text-primary mt-1">diverse-technology-applications</p>
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Diverse Technology Applications"
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                placeholder="WiFi sensing technology deployed across multiple care environments..."
                rows={2}
              />
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <div className="flex justify-between items-center">
              <CardTitle>Application Cards</CardTitle>
...
export default DiverseTechnologyApplicationsManager;
