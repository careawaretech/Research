...
const FooterStyleManager = () => {
  ...
  const [styles, setStyles] = useState<FooterStyles>({
  ...
  const fetchStyles = async () => {
    try {
      ...
      toast.error('Failed to load footer styles');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success('Footer styles updated successfully');
    } catch (error) {
      console.error('Error saving styles:', error);
      toast.error('Failed to save footer styles');
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold">Footer Style Manager</h1>
          </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="p-6 rounded-lg border" style={{
              ...
              <p>This is how your footer colors will look.</p>
            </div>
          </CardContent>
        </Card>
      </div>
